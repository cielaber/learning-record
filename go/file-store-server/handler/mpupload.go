...
import (
	...
	rPool "file-store-server/cache/redis"
...
func UploadPartHandler(w http.ResponseWriter, r *http.Request) {
	...
	dir, err := os.Getwd()
	if err != nil {
		fmt.Println("os.Getwd err:", err.Error())
	}
	fpath := path.Join(dir, uploadID, chunkIndex)
...
func CompleteUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("redis.Values err:", err.Error())
	...
	if totalCount != chunkCount {
		fmt.Printf("totalCount: %d chunkCount: %d", totalCount, chunkCount)
